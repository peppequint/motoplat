...
<body>
	...
	<section id="form_send">
		<article>
			...
			<h1>Obrigado por ter preenchido o formulário de contato.</h1>
			<p>Entraremos em contato o mais breve possível.</p>
			<a href="index.html"><button>volte</button></a>
		</article>
	</section>
		<?php
			...
			$message .= '<tr><td><strong>Website:</strong></td><td>Portugese versie</td></tr>';
			$message .= '</table>';
			$message .= '</body></html>';
