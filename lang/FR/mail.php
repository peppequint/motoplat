...
<body>
	...
	<section id="form_send">
		<article>
			...
			<h1>Merci d'avoir rempli le formulaire de contact.</h1>
			<p>Nous vous recontacterons prochaînement.</p>
			<a href="index.html"><button>precedent</button></a>
		</article>
	</section>
		<?php
			...
			$message .= '<tr><td><strong>Website:</strong></td><td>Franse versie</td></tr>';
			$message .= '</table>';
			$message .= '</body></html>';
